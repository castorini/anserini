...
+ Regressions for BEIR (v1.0.0):
  ...
  + Signal-1M(RT): ["flat" baseline](docs/regressions-beir-v1.0.0-signal1m-flat.md), [SPLADE-distill CoCodenser-medium](docs/regressions-beir-v1.0.0-signal1m-splade-distil-cocodenser-mediu.md)
