...
+ [Regressions for the TREC 2020 Deep Learning Track (Passage Ranking Task)](docs/regressions-dl20-passage.md)
+ [Regressions for the TREC 2020 Deep Learning Track (Passage Ranking Task) with docTTTTT expansion](docs/regressions-dl20-passage-docTTTTTquery.md)
+ [Regressions for the TREC 2020 Deep Learning Track (Document Ranking Task)](docs/regressions-dl20-doc.md)
+ [Regressions for the TREC 2020 Deep Learning Track (Document Ranking Task) with per-doc docTTTTT expansion](docs/regressions-dl20-doc-docTTTTTquery-per-doc.md)
