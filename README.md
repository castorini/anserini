...
+ Regressions for MS MARCO (V1) Passage Ranking:
  + Bag-of-words: [baselines](docs/regressions-msmarco-passage.md), [doc2query](docs/regressions-msmarco-passage-doc2query.md), [doc2query-T5](docs/regressions-msmarco-passage-docTTTTTquery.md)
...
+ Regressions for TREC 2019 Deep Learning:
...
+ Regressions for TREC 2020 Deep Learning:
...
+ Regressions for TREC 2021 Deep Learning:
...
+ Regressions for MS MARCO (V2) Passage Ranking:
  + dev queries: [baselines](docs/regressions-msmarco-v2-passage-dev.md), [on augmented corpus](docs/regressions-msmarco-v2-passage-augmented-dev.md), [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-passage-unicoil-noexp-0shot-dev.md)
  + dev2 queries: [baselines](docs/regressions-msmarco-v2-passage-dev2.md), [on augmented corpus](docs/regressions-msmarco-v2-passage-augmented-dev2.md), [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-passage-unicoil-noexp-0shot-dev2.md)
+ Regressions for MS MARCO (V2) Document Ranking:
  + dev queries: [baselines](docs/regressions-msmarco-v2-doc-dev.md), [on segmented corpus](docs/regressions-msmarco-v2-doc-segmented-dev.md), [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-doc-segmented-unicoil-noexp-0shot-dev.md)
  + dev2 queries: [baselines](docs/regressions-msmarco-v2-doc-dev2.md), [on segmented corpus](docs/regressions-msmarco-v2-doc-segmented-dev2.md),  [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-doc-segmented-unicoil-noexp-0shot-dev2.md)
