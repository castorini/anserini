...
+ Regressions for MS MARCO Document Ranking, Per Passage: [baselines](docs/regressions-msmarco-doc-per-passage.md) ([v2](docs/regressions-msmarco-doc-per-passage-v2.md), [v3](docs/regressions-msmarco-doc-per-passage-v3.md)), [doc2query-T5](docs/regressions-msmarco-doc-docTTTTTquery-per-passage.md) ([v3](docs/regressions-msmarco-doc-docTTTTTquery-per-passage-v3.md))
...
+ Regressions for TREC 2021 Deep Learning (Passage): [baselines](docs/regressions-dl21-passage.md)
+ Regressions for TREC 2021 Deep Learning (Passage, Augmented): [baselines](docs/regressions-dl21-passage-augmented.md)
+ Regressions for TREC 2021 Deep Learning (Document): [baselines](docs/regressions-dl21-doc.md)
+ Regressions for TREC 2021 Deep Learning (Document, Segmented): [baselines](docs/regressions-dl21-doc-segmented.md)
