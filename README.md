...
See [detailed instructions](docs/fatjar-regressions-v0.35.1.md) for using Anserini (v0.35.1) to reproduce runs for MS MARCO V2.1 for TREC 2024 RAG, MS MARCO V1 Passage, and BEIR, all directly from the fatjar!
Older instructions:
