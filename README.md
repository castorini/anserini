...
+ Regressions for MS MARCO Document Ranking, Per Passage: [baselines](docs/regressions-msmarco-doc-per-passage.md) ([v2](docs/regressions-msmarco-doc-per-passage-v2.md), [v3](docs/regressions-msmarco-doc-per-passage-v3.md))[*](docs/experiments-msmarco-doc-doc2query-details.md), [doc2query-T5](docs/regressions-msmarco-doc-docTTTTTquery-per-passage.md) ([v3](docs/regressions-msmarco-doc-docTTTTTquery-per-passage-v3.md))[*](docs/experiments-msmarco-doc-doc2query-details.md)
...
+ Regressions for TREC 2021 Deep Learning (Passage): [baselines](docs/regressions-dl21-passage.md), [on augmented corpus](docs/regressions-dl21-passage-augmented.md)
+ Regressions for TREC 2021 Deep Learning (Passage): [uniCOIL noexp zero-shot](docs/dl21-passage-unicoil-noexp-0shot.md)
+ Regressions for TREC 2021 Deep Learning (Document): [baselines](docs/regressions-dl21-doc.md), [on segmented corpus](docs/regressions-dl21-doc-segmented.md)
+ Regressions for TREC 2021 Deep Learning (Document): [uniCOIL noexp zero-shot](docs/dl21-doc-segmented-unicoil-noexp-0shot.md)
+ Regressions for MS MARCO (V2) Passage Ranking (dev): [baselines](docs/regressions-msmarco-v2-passage-dev.md), [on augmented corpus](docs/regressions-msmarco-v2-passage-augmented-dev.md)
+ Regressions for MS MARCO (V2) Passage Ranking (dev): [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-passage-unicoil-noexp-0shot-dev.md)
+ Regressions for MS MARCO (V2) Passage Ranking (dev2): [baselines](docs/regressions-msmarco-v2-passage-dev2.md), [on augmented corpus](docs/regressions-msmarco-v2-passage-augmented-dev2.md)
+ Regressions for MS MARCO (V2) Document Ranking (dev): [baselines](docs/regressions-msmarco-v2-doc-dev.md), [on segmented corpus](docs/regressions-msmarco-v2-doc-segmented-dev.md)
+ Regressions for MS MARCO (V2) Document Ranking (dev): [uniCOIL noexp zero-shot](docs/regressions-msmarco-v2-doc-segmented-unicoil-noexp-0shot-dev.md)
+ Regressions for MS MARCO (V2) Document Ranking (dev2): [baselines](docs/regressions-msmarco-v2-doc-dev2.md), [on segmented corpus](docs/regressions-msmarco-v2-doc-segmented-dev2.md)
