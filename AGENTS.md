...
- Use `$install-anserini-dev-env` when the user needs source checkout setup, Java/Maven verification, full or quick builds, or Maven troubleshooting.
...
1. Confirm Java 21 and Maven 3.9+; use `$install-anserini-dev-env` for detailed setup checks.
