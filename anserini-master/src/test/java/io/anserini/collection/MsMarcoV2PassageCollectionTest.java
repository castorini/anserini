...
public class MsMarcoV2PassageCollectionTest extends DocumentCollectionTest<MsMarcoV2PassageCollection.Document> {
  ...
  public void setUp() throws Exception {
    ...
    collectionPath = Paths.get("src/test/resources/sample_docs/msmarco_v2_passage/");
    collection = new MsMarcoV2PassageCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/msmarco_v2_passage/docs.json");
