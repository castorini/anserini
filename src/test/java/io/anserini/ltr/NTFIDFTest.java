...
import io.anserini.ltr.feature.base.NTFIDF;
...
public class NTFIDFTest extends BaseFeatureExtractorTest<Integer>{
    private static final FeatureExtractor EXTRACTOR = new NTFIDF();
    /*
