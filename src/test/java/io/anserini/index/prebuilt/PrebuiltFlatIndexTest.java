...
public class PrebuiltFlatIndexTest {
  ...
  public void testParseEntriesFromMetadataFile() throws Exception {
    List<PrebuiltFlatIndex.Entry> entries = PrebuiltIndex.parseEntriesFromJson(PrebuiltIndex.IndexType.FLAT, PrebuiltFlatIndex.Entry.class,
        "[{\"name\":\"TEST\",\"type\":\"flat\"},{\"name\":\"SKIP\",\"type\":\"hnsw\"}]");
