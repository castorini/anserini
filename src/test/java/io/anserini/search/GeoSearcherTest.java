...
public class GeoSearcherTest extends GeoIndexerTestBase {
    ...
    public void testGetMultiPolygon() throws Exception {
        ...
        Query q1 = LatLonShape.newBoxQuery("geometry", ShapeField.QueryRelation.WITHIN,
                -10, 25, 30, 80);
    ...
    public void testGetGrandRiver() throws Exception {
        ...
        Query q = LatLonShape.newBoxQuery("geometry", ShapeField.QueryRelation.WITHIN,
                43.46, 43.56, -80.52, -80.45);
        TopDocs hits = searcher.search(q, 5);
        assertEquals(1, hits.totalHits.value);
