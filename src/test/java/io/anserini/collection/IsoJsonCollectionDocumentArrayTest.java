...
public class IsoJsonCollectionDocumentArrayTest extends IsoJsonCollectionTest {

  @Before
  public void setUp() throws Exception {
    super.setUp();

    collectionPath = Paths.get("src/test/resources/sample_docs/json/IsoCollection2");
    collection = new IsoJsonCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/json/IsoCollection2/IsoSegment1.json");
