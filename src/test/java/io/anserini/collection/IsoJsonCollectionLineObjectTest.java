...
public class IsoJsonCollectionLineObjectTest extends JsonCollectionTest {
  ...
  public void setUp() throws Exception {
    ...
    collectionPath = Paths.get("src/test/resources/sample_docs/json/IsoCollection3");
    collection = new IsoJsonCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/json/IsoCollection3/IsoSegment1.json");
