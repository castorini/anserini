...
public class JsonCollectionDocumentObjectCompressedTest extends JsonCollectionTest {
  @Before
  public void setUp() throws Exception {
    super.setUp();

    collectionPath = Paths.get("src/test/resources/sample_docs/json/collection1_gz");
    collection = new JsonCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/json/collection1_gz/doc1.json.gz");
    Path segment2 = Paths.get("src/test/resources/sample_docs/json/collection1_gz/doc2.json.gz");
