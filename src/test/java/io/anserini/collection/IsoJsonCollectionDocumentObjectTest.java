...
public class IsoJsonCollectionDocumentObjectTest extends JsonCollectionTest {
  ...
  public void setUp() throws Exception {
    ...
    collectionPath = Paths.get("src/test/resources/sample_docs/json/IsoCollection1");
    collection = new IsoJsonCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/json/IsoCollection1/IsoDoc1.json");
    Path segment2 = Paths.get("src/test/resources/sample_docs/json/IsoCollection1/IsoDoc2.json");
