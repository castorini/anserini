...
public class JsonVectorCollectionLineObjectCompressedTest extends JsonVectorCollectionTest {

  @Before
  public void setUp() throws Exception {
    super.setUp();

    collectionPath = Paths.get("src/test/resources/sample_docs/json_vector/collection3_gz");
    collection = new JsonVectorCollection(collectionPath);

    Path segment1 = Paths.get("src/test/resources/sample_docs/json_vector/collection3_gz/segment1.json.gz");
