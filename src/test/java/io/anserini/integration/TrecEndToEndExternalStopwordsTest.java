...
public class TrecEndToEndExternalStopwordsTest extends EndToEndTest {
  ...
  protected void setSearchGroundTruth() {
    ...
    referenceRunOutput.put("bm25", new String[]{
            "1 Q0 DOC222 1 0.104648 Anserini",
            "1 Q0 TREC_DOC_1 2 0.070280 Anserini",
            "1 Q0 WSJ_1 3 0.067714 Anserini"});

    testQueries.put("qld", createDefaultSearchArgs().qld());
    referenceRunOutput.put("qld", new String[]{
            "1 Q0 DOC222 1 0.003976 Anserini",
            "1 Q0 WSJ_1 2 0.000000 Anserini",
            "1 Q0 TREC_DOC_1 3 0.000000 Anserini"});

    testQueries.put("qljm", createDefaultSearchArgs().qljm());
    referenceRunOutput.put("qljm", new String[]{
            "1 Q0 DOC222 1 2.944439 Anserini",
            "1 Q0 TREC_DOC_1 2 1.757858 Anserini",
            "1 Q0 WSJ_1 3 1.609438 Anserini"});

    testQueries.put("inl2", createDefaultSearchArgs().inl2());
    referenceRunOutput.put("inl2", new String[]{
            "1 Q0 DOC222 1 0.065047 Anserini",
            "1 Q0 TREC_DOC_1 2 0.023287 Anserini",
            "1 Q0 WSJ_1 3 0.019943 Anserini"});

    testQueries.put("spl", createDefaultSearchArgs().spl());
    referenceRunOutput.put("spl", new String[]{
            "1 Q0 DOC222 1 0.411961 Anserini",
            "1 Q0 TREC_DOC_1 2 0.128836 Anserini",
            "1 Q0 WSJ_1 3 0.109282 Anserini"});

    testQueries.put("f2exp", createDefaultSearchArgs().f2exp());
    referenceRunOutput.put("f2exp", new String[]{
            "1 Q0 DOC222 1 0.850717 Anserini",
            "1 Q0 TREC_DOC_1 2 0.552966 Anserini",
            "1 Q0 WSJ_1 3 0.526634 Anserini"});

    testQueries.put("f2log", createDefaultSearchArgs().f2log());
    referenceRunOutput.put("f2log", new String[]{
            "1 Q0 DOC222 1 0.221294 Anserini",
            "1 Q0 TREC_DOC_1 2 0.143841 Anserini",
            "1 Q0 WSJ_1 3 0.136991 Anserini"});
  }
}
