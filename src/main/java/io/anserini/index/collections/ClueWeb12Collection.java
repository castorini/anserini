...
public class ClueWeb12Collection<D extends ClueWeb12WarcRecord> extends WarcCollection {
    public ClueWeb12Collection(Path inputDir) throws IOException {
        super(inputDir);
    }

    public ClueWeb12Collection(WarcCollection c) {
        super(c);
    }
