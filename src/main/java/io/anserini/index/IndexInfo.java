...
public enum IndexInfo {
  ...
  BEIR_V1_0_0_CQADUPSTACK_ENGLI_FLATSH_BGE_BASE_EN_15("beir-v1.0.0-cqadupstack-english.bge-base-en-v1.5.flat",
  ...
  IndexInfo(String indexName, String description, String filename, String corpus, String model, String[] urls, String md5) {
