...
import io.anserini.collection.NoCleanC4Collection;
...
public class NoCleanC4Generator extends DefaultLuceneDocumentGenerator<NoCleanC4Collection.Document>{
  ...
  public NoCleanC4Generator(IndexArgs args) {
    super(args);
    this.args = args;
  }

  public Document createDocument(NoCleanC4Collection.Document doc) throws GeneratorException {
