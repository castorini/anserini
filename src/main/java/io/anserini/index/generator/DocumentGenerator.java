 ...
 */
public class DocumentGenerator<T extends SourceDocument> {
  private static final Logger LOG = LogManager.getLogger(DocumentGenerator.class);
   ...
   */
  public DocumentGenerator(StringTransform transform) {
