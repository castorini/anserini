...
public enum Topics {
  ...
  GART5_NQ_TEST_ANSWERS(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.nq-test.answers.tsv"),
  GART5_NQ_TEST_TITLES(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.nq-test.titles.tsv"),
  GART5_NQ_TEST_SENTENCES(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.nq-test.sentences.tsv"),
  GART5_NQ_TEST_ALL(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.nq-test.all.tsv"),
  GART5_DPR_TRIVIA_TEST_ANSWERS(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.dpr-trivia-test.answers.tsv"),
  GART5_DPR_TRIVIA_TEST_TITLES(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.dpr-trivia-test.titles.tsv"),
  GART5_DPR_TRIVIA_TEST_SENTENCES(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.dpr-trivia-test.sentences.tsv"),
  GART5_DPR_TRIVIA_TEST_ALL(TsvIntTopicReader.class, "topics-and-qrels/topics.gar-t5.dpr-trivia-test.all.tsv"),
