...
public enum Topics {
  ...
  M_BEIR_CIRR_TASK7_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-cirr_task7.test.jsonl"),
  M_BEIR_EDIS_TASK2_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-edis_task2.test.jsonl"),
  M_BEIR_FASHION200K_TASK0_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-fashion200k_task0.test.jsonl"),
  M_BEIR_FASHION200K_TASK3_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-fashion200k_task3.test.jsonl"),
  M_BEIR_FASHIONIQ_TASK7_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-fashioniq_task7.test.jsonl"),
  M_BEIR_INFOSEEK_TASK6_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-infoseek_task6.test.jsonl"),
  M_BEIR_INFOSEEK_TASK8_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-infoseek_task8.test.jsonl"),
  M_BEIR_MSCOCO_TASK0_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-mscoco_task0.test.jsonl"),
  M_BEIR_MSCOCO_TASK3_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-mscoco_task3.test.jsonl"),
  M_BEIR_NIGHTS_TASK4_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-nights_task4.test.jsonl"),
  M_BEIR_OVEN_TASK6_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-oven_task6.test.jsonl"),
  M_BEIR_OVEN_TASK8_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-oven_task8.test.jsonl"),
  M_BEIR_VISUALNEWS_TASK0_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-visualnews_task0.test.jsonl"),
  M_BEIR_VISUALNEWS_TASK3_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-visualnews_task3.test.jsonl"),
  M_BEIR_WEBQA_TASK1_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-webqa_task1.test.jsonl"),
  M_BEIR_WEBQA_TASK2_TEST(JsonStringVectorTopicReader.class, "topics.mbeir-webqa_task2.test.jsonl"),
