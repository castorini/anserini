...
public enum Topics {
  ...
  NEUCLIR22_EN_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-en.orig-title.txt"),
  NEUCLIR22_EN_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-en.orig-desc.txt"),
  NEUCLIR22_EN_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-en.orig-desc_title.txt"),
  NEUCLIR22_FA_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.orig-title.txt"),
  NEUCLIR22_FA_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.orig-desc.txt"),
  NEUCLIR22_FA_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.orig-desc_title.txt"),
  NEUCLIR22_RU_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.orig-title.txt"),
  NEUCLIR22_RU_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.orig-desc.txt"),
  NEUCLIR22_RU_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.orig-desc_title.txt"),
  NEUCLIR22_ZH_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.orig-title.txt"),
  NEUCLIR22_ZH_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.orig-desc.txt"),
  NEUCLIR22_ZH_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.orig-desc_title.txt"),

  // TREC NeuCLIR 2022 Topics, SPLADE
  NEUCLIR22_FA_SPLADE_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.splade.orig-title.txt.gz"),
  NEUCLIR22_FA_SPLADE_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.splade.orig-desc.txt.gz"),
  NEUCLIR22_FA_SPLADE_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-fa.splade.orig-desc_title.txt.gz"),
//  NEUCLIR22_RU_SPLADE_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.splade.orig-title.txt"),
//  NEUCLIR22_RU_SPLADE_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.splade.orig-desc.txt"),
//  NEUCLIR22_RU_SPLADE_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-ru.splade.orig-desc_title.txt"),
//  NEUCLIR22_ZH_SPLADE_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.splade.orig-title.txt"),
//  NEUCLIR22_ZH_SPLADE_DESC(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.splade.orig-desc.txt"),
//  NEUCLIR22_ZH_SPLADE_DESC_TITLE(TsvIntTopicReader.class, "topics-and-qrels/topics.neuclir22-zh.splade.orig-desc_title.txt"),
