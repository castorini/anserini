...
public enum Topics {
  ...
  TREC2021_DL_UNICOIL(TsvIntTopicReader.class,"topics-and-qrels/topics.dl21.unicoil.tsv.gz"),
  TREC2021_DL_UNICOIL_NOEXP(TsvIntTopicReader.class,"topics-and-qrels/topics.dl21.unicoil-noexp.tsv.gz"),
