...
public class SpladePpEdMsmarcoPassageEncoder extends QueryEncoder{
    ...
    public SpladePpEdMsmarcoPassageEncoder(int weightRange, int quantRange) throws IOException, OrtException {
