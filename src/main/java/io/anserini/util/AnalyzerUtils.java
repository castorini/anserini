...
//    builder.add(termsBuilder.build(), BooleanClause.Occur.SHOULD);
//    builder.add(orderedWindowBuilder.build(), BooleanClause.Occur.SHOULD);
//    builder.add(unorderedWindowBuilder.build(), BooleanClause.Occur.SHOULD);
