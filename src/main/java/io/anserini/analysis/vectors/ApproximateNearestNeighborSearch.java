...
import io.anserini.analysis.vectors.lexlsh.LexicalLSH2Analyzer;
...
public class ApproximateNearestNeighborSearch {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (indexArgs.encoding.equalsIgnoreCase(FW)) {
      ...
      vectorAnalyzer = new LexicalLSH2Analyzer(indexArgs.decimals, indexArgs.ngrams, indexArgs.hashCount,
