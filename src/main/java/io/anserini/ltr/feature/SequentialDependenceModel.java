 ...
 */
public class SequentialDependenceModel implements FeatureExtractor<String> {
  ...
  private float computeUnorderedFrequencyScore(Document doc, Terms terms, RerankerContext<String> context) throws IOException {
  ...
  private float computeOrderedFrequencyScore(Document doc, Terms terms, RerankerContext<String> context) throws IOException {
    List<String> queryTokens = context.getQueryTokens();
    Map<String, String> queryPairMap = new HashMap<>();
    Map<String, Integer> phraseCountMap = new HashMap<>();
    Map<String, Integer> singleCountMap = new HashMap<>();
   ...
   * @return
   */
  private float computeFullIndependenceScore(Document doc, Terms terms, RerankerContext<String> context) throws IOException {
