...
public class BM25HMean implements FeatureExtractor {
    ...
    public BM25HMean(Pooler collectFun, double k, double b) {
        this.k1 = k;
        this.b = b;
        this.field = IndexArgs.CONTENTS;
        this.collectFun = collectFun;
    ...
    public BM25HMean(Pooler collectFun, double k, double b, String field) {
        this.k1 = k;
        this.b = b;
        this.field = field;
        this.collectFun = collectFun;
    ...
    public String getName() {
        return String.format("%s_%s_BM25_HMean_k1_%.2f_b_%.2f_%s",field, qfield, k1, b, collectFun.getName());
    }
    ...
    public FeatureExtractor clone() {
        ...
        return new BM25HMean(newFun, k1, b, field);
    }
