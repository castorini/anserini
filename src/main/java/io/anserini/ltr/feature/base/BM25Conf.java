...
public class BM25Conf implements FeatureExtractor {
    private static final Logger LOG = LogManager.getLogger(BM25Conf.class);
    // Default values, could be changed
    private double k1 = 0.9;
    private double b = 0.4;
    private String field;
    Pooler collectFun;
    public BM25Conf(Pooler collectFun) {
        this.field = IndexArgs.CONTENTS;
        this.collectFun = collectFun;
    }

    public BM25Conf(double k, double b, Pooler collectFun) {
        this.k1 = k;
        this.b = b;
        this.field = IndexArgs.CONTENTS;
        this.collectFun = collectFun;
    ...
    public float extract(DocumentContext documentContext, QueryContext queryContext) {
        ...
        List<Float> scores = context.generateBM25Conf(queryContext.queryTokens,k1,b);
    ...
    public String getName() {
        return String.format("%s_BM25_Conf_k1_%.2f_b_%.2f_%s",field, k1, b, collectFun.getName());
    }
