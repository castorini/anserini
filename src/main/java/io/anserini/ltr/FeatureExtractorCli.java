...
public class FeatureExtractorCli {
  ...
  private static class FeatureExtractionArgs {
    ...
    @Option(name = "-collection", metaVar = "[path]", required = true, usage = "[clueweb|gov2|twitter|wt10g]")
  ...
  public static void main(String args[]) throws Exception {
    ...
    if (parsedArgs.collection.equals("Trec") || parsedArgs.collection.equals("Webxml")) {
      ...
      String className = (parsedArgs.collection.equals("gov2") || parsedArgs.collection.equals("wt10g")) ? "Trec" : "Webxml";
