...
public final class IndexW2V {
  ...
  public static final class Args {
    ...
    //optional arguments
    @Option(name = "--build", usage = "builds index if specified")
  ...
  public float[] getEmbeddings(String term) throws IOException {
  ...
  public static void main(String[] args) throws Exception {
    ...
    IndexW2V index = new IndexW2V(indexCollectionArgs);

    if (indexCollectionArgs.build) {
      index.indexEmbeddings();
    }

    if (!indexCollectionArgs.term.isEmpty()) {
        System.out.println(Arrays.toString(index.getEmbeddings(indexCollectionArgs.term)));
    }
  }
}
