...
if __name__ == '__main__':
    ...
    parser.add_argument('--candidate_file', required=True, default='', help='candidate id file')
    ...
    with open(args.output, 'w') as fout:
      candidates = set(open(args.candidate_file).read().strip().split('\n'))
      ...
      for line_number, line in enumerate(open(args.qid_queries)):
          ...
          for i in range(len(hits)):
              ...
              if doc_id == query_id or doc_id not in candidates:
                  continue
