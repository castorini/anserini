...
def build_docid_idx_and_label(rank_file_folder):
  ...
  rank_files =['qrels.robust2004.txt', 'qrels.robust2005.txt', 'qrels.core17.txt']
...
def build_vocab_tfidf_dict(tfidf_raw_folder, docid_idx_dict, isalpha):
  ...
  tfidf_raw_files = ['lucene-index.robust04.pos+docvectors+rawdocs.allDocids.txt.docvector.TF_IDF.tar.gz',
                     'lucene-index.robust05.pos+docvectors+rawdocs.allDocids.txt.docvector.TF_IDF.tar.gz',
                     'lucene-index.core17.pos+docvectors+rawdocs.allDocids.txt.docvector.TF_IDF.tar.gz']
...
if __name__ == '__main__':
  ...
  tfidf_file_folder = '.'
  rank_file_folder = 'src/main/resources/topics-and-qrels/'
