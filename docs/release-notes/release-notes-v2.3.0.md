...
+ Moved topics and qrels to separate [`eval`](https://github.com/castorini/eval/) repo (with local "holding area").
+ Removed the `anserini-tools` submodule and dependency from document-collection reproductions, with corresponding fixes to reproduction commands.
...
+ Namgyu Kim ([danmuzi](https://github.com/danmuzi))
