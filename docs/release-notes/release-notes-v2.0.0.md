...
+ Upgraded Anserini to Lucene 10.4.0, including accompanying dense vector and codec updates.
+ Expanded reproduction coverage for TREC 2025 RAG Track.
...
+ Shahnawaz Hossain ([ShanaxWorld](https://github.com/ShanaxWorld))
+ Shakirul Hasan Khan ([KhanShaheb34](https://github.com/KhanShaheb34))
