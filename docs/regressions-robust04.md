...
The directory `/path/to/disk45/` should be the root directory of [Disks 4 &amp; 5](https://trec.nist.gov/data_disks.html); inside each there should be subdirectories like `ft`, `fr94`.
