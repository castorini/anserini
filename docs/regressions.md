...
```bash
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage >& logs/log.msmarco-v1-passage &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bm25-b8 >& logs/log.msmarco-v1-passage.bm25-b8 &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.wp-tok >& logs/log.msmarco-v1-passage.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.wp-hgf >& logs/log.msmarco-v1-passage.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.wp-ca >& logs/log.msmarco-v1-passage.wp-ca &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.doc2query >& logs/log.msmarco-v1-passage.doc2query &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.docTTTTTquery >& logs/log.msmarco-v1-passage.docTTTTTquery &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.deepimpact >& logs/log.msmarco-v1-passage.deepimpact &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.unicoil >& logs/log.msmarco-v1-passage.unicoil &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.unicoil-noexp >& logs/log.msmarco-v1-passage.unicoil-noexp &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.unicoil-tilde-expansion >& logs/log.msmarco-v1-passage.unicoil-tilde-expansion &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.distill-splade-max >& logs/log.msmarco-v1-passage.distill-splade-max &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.splade-pp-ed >& logs/log.msmarco-v1-passage.splade-pp-ed &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.splade-pp-ed.onnx >& logs/log.msmarco-v1-passage.splade-pp-ed.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.splade-pp-sd >& logs/log.msmarco-v1-passage.splade-pp-sd &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.splade-pp-sd.onnx >& logs/log.msmarco-v1-passage.splade-pp-sd.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.hnsw >& logs/log.msmarco-v1-passage.cos-dpr-distil.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.hnsw.onnx >& logs/log.msmarco-v1-passage.cos-dpr-distil.hnsw.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.hnsw-int8 >& logs/log.msmarco-v1-passage.cos-dpr-distil.hnsw-int8 &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.hnsw-int8.onnx >& logs/log.msmarco-v1-passage.cos-dpr-distil.hnsw-int8.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.fw >& logs/log.msmarco-v1-passage.cos-dpr-distil.fw &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cos-dpr-distil.lexlsh >& logs/log.msmarco-v1-passage.cos-dpr-distil.lexlsh &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.hnsw >& logs/log.msmarco-v1-passage.bge-base-en-v1.5.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.hnsw.onnx >& logs/log.msmarco-v1-passage.bge-base-en-v1.5.hnsw.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.hnsw-int8 >& logs/log.msmarco-v1-passage.bge-base-en-v1.5.hnsw-int8 &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.hnsw-int8.onnx >& logs/log.msmarco-v1-passage.bge-base-en-v1.5.hnsw-int8.onnx &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cohere-embed-english-v3.0.hnsw >& logs/log.msmarco-v1-passage.cohere-embed-english-v3.0.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.cohere-embed-english-v3.0.hnsw-int8 >& logs/log.msmarco-v1-passage.cohere-embed-english-v3.0.hnsw-int8 &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.openai-ada2.hnsw >& logs/log.msmarco-v1-passage.openai-ada2.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.openai-ada2.hnsw-int8 >& logs/log.msmarco-v1-passage.openai-ada2.hnsw-int8 &

nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc >& logs/log.msmarco-v1-doc &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc.wp-tok >& logs/log.msmarco-v1-doc.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc.wp-hgf >& logs/log.msmarco-v1-doc.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc.wp-ca >& logs/log.msmarco-v1-doc.wp-ca &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc.docTTTTTquery >& logs/log.msmarco-v1-doc.docTTTTTquery &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented >& logs/log.msmarco-v1-doc-segmented &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented.wp-tok >& logs/log.msmarco-v1-doc-segmented.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented.wp-ca >& logs/log.msmarco-v1-doc-segmented.wp-ca &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented.docTTTTTquery >& logs/log.msmarco-v1-doc-segmented.docTTTTTquery &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented.unicoil >& logs/log.msmarco-v1-doc-segmented.unicoil &
nohup python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-doc-segmented.unicoil-noexp >& logs/log.msmarco-v1-doc-segmented.unicoil-noexp &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-passage.wp-tok >& logs/log.dl19-passage.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-passage.wp-hgf >& logs/log.dl19-passage.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-passage.wp-ca >& logs/log.dl19-passage.wp-ca &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-passage.openai-ada2.hnsw >& logs/log.dl19-passage.openai-ada2.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-passage.openai-ada2.hnsw-int8 >& logs/log.dl19-passage.openai-ada2.hnsw-int8 &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-doc.wp-tok >& logs/log.dl19-doc.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-doc.wp-hgf >& logs/log.dl19-doc.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-doc.wp-ca >& logs/log.dl19-doc.wp-ca &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-doc-segmented.wp-tok >& logs/log.dl19-doc-segmented.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl19-doc-segmented.wp-ca >& logs/log.dl19-doc-segmented.wp-ca &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.wp-tok >& logs/log.dl20-passage.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.wp-hgf >& logs/log.dl20-passage.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.wp-ca >& logs/log.dl20-passage.wp-ca &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.openai-ada2.hnsw >& logs/log.dl20-passage.openai-ada2.hnsw &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.openai-ada2.hnsw-int8 >& logs/log.dl20-passage.openai-ada2.hnsw-int8 &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-doc.wp-tok >& logs/log.dl20-doc.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-doc.wp-hgf >& logs/log.dl20-doc.wp-hgf &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-doc.wp-ca >& logs/log.dl20-doc.wp-ca &
...
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-doc-segmented.wp-tok >& logs/log.dl20-doc-segmented.wp-tok &
nohup python src/main/python/run_regression.py --index --verify --search --regression dl20-doc-segmented.wp-ca >& logs/log.dl20-doc-segmented.wp-ca &
