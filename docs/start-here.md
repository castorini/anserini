...
+ Results reproduced by [@sibi-ai](https://github.com/sibi-ai) on 2026-04-07 (commit [`295fdbf`](https://github.com/castorini/anserini/commit/295fdbf6173f1e3663a541dca82a2f1c00026)) using Google Colab on macOS, Java 21, Maven 3.9. All steps completed successfully.
