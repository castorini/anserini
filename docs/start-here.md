...
* 2026-03-10 @mahdijaf reproduced the MS MARCO data preparation steps on Windows 10 using Python 3.14.3 and Java 21. Generated the JSONL collection (9 files) and verified that queries.dev.small.tsv contains 6980 queries.