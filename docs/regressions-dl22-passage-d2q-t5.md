...
The "BM25 + RM3" and "BM25 + Rocchio" conditions above correspond to run `p_d2q_bm25rm3` and run `p_d2q_bm25rocchio` submitted to the TREC 2022 Deep Learning Track as "baselines".
