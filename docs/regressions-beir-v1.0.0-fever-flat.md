...
target/appassembler/bin/SearchCollection \
  ...
  -output runs/run.beir-v1.0.0-fever.flat-default.topics.beir-v1.0.0-fever.test.txt \
...
```
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.10 src/main/resources/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.flat-default.topics.beir-v1.0.0-fever.test.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.100 src/main/resources/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.flat-default.topics.beir-v1.0.0-fever.test.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.flat-default.topics.beir-v1.0.0-fever.test.txt
```
