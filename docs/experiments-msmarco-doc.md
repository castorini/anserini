...
The final grid uses `k1=3.0:5.5:0.1` and `b=0.75:0.95:0.05`: 130 parameter pairs across five training samples, totaling 650 searches, followed by development evaluation of the averaged parameters.
...
MRR is evaluated separately from MAP and recall using the same 1,000-hit ranking, and the new workflow selects MRR and MAP parameters independently.
