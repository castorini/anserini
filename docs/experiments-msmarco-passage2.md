...
+ Results reproduced by [@ahmadsiddiqui25](https://github.com/ahmadsiddiqui25) on 2026-09-13 (commit [`5821717`](https://github.com/castorini/anserini/commit/58217175b415efb953fdf5d7e84d3773ae09f966)) — BM25-via-prebuilt-index section reproduced exactly (MRR@10 0.1875); BGE dense retrieval not completed due to persistent network issues downloading the 26GB prebuilt HNSW index.
