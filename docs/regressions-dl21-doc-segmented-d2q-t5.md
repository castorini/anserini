...
This page describes experiments, integrated into Anserini's regression testing framework, on the TREC 2021 Deep Learning Track (document ranking task) using the MS MARCO V2 _segmented_ document collection (with doc2query-T5 expansions).
