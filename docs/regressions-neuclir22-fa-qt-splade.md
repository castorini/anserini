...
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-title.txt \
  -impact -pretokenized &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc.txt \
  -impact -pretokenized &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc_title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc_title.txt \
  -impact -pretokenized &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
...
target/appassembler/bin/SearchCollection \
  ...
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-title.txt \
  -impact -pretokenized -rm3 &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc.txt \
  -impact -pretokenized -rm3 &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc_title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc_title.txt \
  -impact -pretokenized -rm3 &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.mt-title.txt.gz \
...
target/appassembler/bin/SearchCollection \
  ...
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-title.txt \
  -impact -pretokenized -rocchio &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc.txt \
  -impact -pretokenized -rocchio &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.orig-desc_title.txt.gz \
  -topicreader TsvInt \
  -output runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc_title.txt \
  -impact -pretokenized -rocchio &
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.neuclir22-fa-splade \
  -topics src/main/resources/topics-and-qrels/topics.neuclir22-fa.splade.mt-title.txt.gz \
...
```
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc_title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade.topics.neuclir22-fa.splade.orig-desc_title.txt
...
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc_title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rm3.topics.neuclir22-fa.splade.orig-desc_title.txt
...
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m ndcg_cut.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc_title.txt
python -m pyserini.eval.trec_eval -c -m judged.20 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m recall.1000 src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc_title.txt
tools/eval/trec_eval.9.0.4/trec_eval -c -m map src/main/resources/topics-and-qrels/qrels.neuclir22-fa.txt runs/run.neuclir22-fa.splade+rocchio.topics.neuclir22-fa.splade.orig-desc_title.txt
...
|:-------------------------------------------------------------------------------------------------------------|-----------|-----------|-----------|
| [NeuCLIR 2022 (Persian): title (original queries)](https://neuclir.github.io/)                               | 0.2896    | 0.2896    | 0.2984    |
| [NeuCLIR 2022 (Persian): desc (original queries)](https://neuclir.github.io/)                                | 0.2959    | 0.2959    | 0.2931    |
| [NeuCLIR 2022 (Persian): desc+title (original queries)](https://neuclir.github.io/)                          | 0.3376    | 0.3376    | 0.2905    |
...
| [NeuCLIR 2022 (Persian): title (original queries)](https://neuclir.github.io/)                               | 0.4301    | 0.4301    | 0.4348    |
| [NeuCLIR 2022 (Persian): desc (original queries)](https://neuclir.github.io/)                                | 0.4413    | 0.4413    | 0.4232    |
| [NeuCLIR 2022 (Persian): desc+title (original queries)](https://neuclir.github.io/)                          | 0.4788    | 0.4788    | 0.4146    |
...
| [NeuCLIR 2022 (Persian): title (original queries)](https://neuclir.github.io/)                               | 0.3684    | 0.3684    | 0.3759    |
| [NeuCLIR 2022 (Persian): desc (original queries)](https://neuclir.github.io/)                                | 0.3741    | 0.3741    | 0.3952    |
| [NeuCLIR 2022 (Persian): desc+title (original queries)](https://neuclir.github.io/)                          | 0.3952    | 0.3952    | 0.4035    |
...
| [NeuCLIR 2022 (Persian): title (original queries)](https://neuclir.github.io/)                               | 0.7652    | 0.7652    | 0.7897    |
| [NeuCLIR 2022 (Persian): desc (original queries)](https://neuclir.github.io/)                                | 0.8173    | 0.8173    | 0.8175    |
| [NeuCLIR 2022 (Persian): desc+title (original queries)](https://neuclir.github.io/)                          | 0.8329    | 0.8329    | 0.8245    |
