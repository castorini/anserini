...
The reproduction completed the historical 35-pair grid on each of five training samples: 175 configurations, followed by development evaluation of the averaged parameters.
