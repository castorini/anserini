...
This page documents regression experiments for passage ranking on the MS MARCO (V2) passage corpus using the dev2 queries, which is integrated into Anserini's regression testing framework.
