# Anserini Fatjar Regresions (v1.4.1-SNAPSHOT)
...
| Corpus                    | BM25 (flat) | BM25 (MF) | SPLADE-v3 | BGE (flat) | BGE (HNSW) |    RRF | Average (normalized) |
|:--------------------------|:-----------:|:---------:|:---------:|:----------:|:----------:|-------:|---------------------:|
...
| `arguana`                 |   0.3970    |  0.4142   |  0.4862   |   0.6375   |   0.6375   | 0.5626 |               0.5738 |
