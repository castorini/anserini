# Anserini Fatjar Regresions (v1.6.0)
...
```bash
export ANSERINI_JAR="anserini-1.6.0-fatjar.jar"
export OUTPUT_DIR="."
```
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression msmarco-v1-doc.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression msmarco-v2-passage.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression msmarco-v2-doc.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression msmarco-v2.1-doc-segmented.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression msmarco-v2.1-doc.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression beir.core
...
```bash
java -cp $ANSERINI_JAR io.anserini.reproduce.RunRegressionsFromPrebuiltIndexes -printCommands -computeIndexSize -regression bright.core
