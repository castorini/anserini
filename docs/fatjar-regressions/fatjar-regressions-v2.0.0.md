...
❗ Anserini was upgraded to Lucene 10.4.0 at [`c6eed6`](https://github.com/castorini/anserini/commit/c6eed686d26d6f39bd75cb44a1fc9385dbbd1b15) (2026/04/12) as part of v2.0.0. Reproductions still use Lucene 9 indexes, and will be gradually replaced with newer indexes over time. Scores reported here are identical to those in the v1.7.1 documentation, but minor difference may emerge due to the Lucene upgrade.
...
The `msmarco-v2.1-doc-segmented` prebuilt index is 83 GB uncompressed.
...
❗ Beware, the complete ArcticEmbed-L index for all 10 shards of the MS MARCO V2.1 segmented document collection totals 557 GB!
