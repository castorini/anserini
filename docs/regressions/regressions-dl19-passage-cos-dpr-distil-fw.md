...
**Model**: cosDPR-distil with inverted indexes "fake-words" technique (q=40), using pre-encoded queries
...
| **AP@1000**                                                                                                  | **cosDPR-distill (FW q=40)**|
|:-------------------------------------------------------------------------------------------------------------|-----------|
| [DL19 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.427     |
| **nDCG@10**                                                                                                  | **cosDPR-distill (FW q=40)**|
| [DL19 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.686     |
| **R@100**                                                                                                    | **cosDPR-distill (FW q=40)**|
| [DL19 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.577     |
| **R@1000**                                                                                                   | **cosDPR-distill (FW q=40)**|
| [DL19 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.790     |
