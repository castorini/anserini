...
```
bin/trec_eval -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-scifact.test.txt runs/run.beir-v1.0.0-scifact-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-scifact.test.unicoil-noexp.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-scifact.test.txt runs/run.beir-v1.0.0-scifact-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-scifact.test.unicoil-noexp.txt
bin/trec_eval -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-scifact.test.txt runs/run.beir-v1.0.0-scifact-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-scifact.test.unicoil-noexp.txt
```
