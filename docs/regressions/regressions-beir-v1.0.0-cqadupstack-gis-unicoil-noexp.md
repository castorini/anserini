...
```
java -jar target/trec_eval.jar -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-gis.test.txt runs/run.beir-v1.0.0-cqadupstack-gis-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-cqadupstack-gis.test.unicoil-noexp.txt
java -jar target/trec_eval.jar -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-gis.test.txt runs/run.beir-v1.0.0-cqadupstack-gis-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-cqadupstack-gis.test.unicoil-noexp.txt
java -jar target/trec_eval.jar -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-gis.test.txt runs/run.beir-v1.0.0-cqadupstack-gis-unicoil-noexp.unicoil-noexp.topics.beir-v1.0.0-cqadupstack-gis.test.unicoil-noexp.txt
```
