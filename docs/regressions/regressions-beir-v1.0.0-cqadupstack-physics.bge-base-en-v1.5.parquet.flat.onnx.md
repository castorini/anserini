...
```
bin/trec_eval -c -m ndcg_cut.10 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.bge-base-en-v1.5.bge-flat-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
bin/trec_eval -c -m recall.100 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.bge-base-en-v1.5.bge-flat-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
bin/trec_eval -c -m recall.1000 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.bge-base-en-v1.5.bge-flat-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
```
