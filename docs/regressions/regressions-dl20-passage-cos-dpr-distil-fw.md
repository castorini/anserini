...
|:-------------------------------------------------------------------------------------------------------------|-----------|
| [DL20 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.427     |
| **nDCG@10**                                                                                                  | **cosDPR-distill**|
| [DL20 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.686     |
| **R@100**                                                                                                    | **cosDPR-distill**|
| [DL20 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.577     |
| **R@1000**                                                                                                   | **cosDPR-distill**|
| [DL20 (Passage)](https://trec.nist.gov/data/deep2020.html)                                                   | 0.790     |
