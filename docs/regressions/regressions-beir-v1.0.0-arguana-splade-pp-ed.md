...
All the BEIR corpora, encoded by SPLADE++ CoCondenser-EnsembleDistil model, are available for download:
...
After download and unpacking the corpora, the `run_regression.py` command should work without any issue.
