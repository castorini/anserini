...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -output runs/run.beir-v1.0.0.bge-base-en-v1.5.bge-flat-int8.topics.beir-v1.0.0-nq.test.bge-base-en-v1.5.jsonl.txt \
...
```
bin/trec_eval -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0.bge-base-en-v1.5.bge-flat-int8.topics.beir-v1.0.0-nq.test.bge-base-en-v1.5.jsonl.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0.bge-base-en-v1.5.bge-flat-int8.topics.beir-v1.0.0-nq.test.bge-base-en-v1.5.jsonl.txt
bin/trec_eval -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0.bge-base-en-v1.5.bge-flat-int8.topics.beir-v1.0.0-nq.test.bge-base-en-v1.5.jsonl.txt
```
