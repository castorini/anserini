# Anserini Regressions: MIRACL (v1.0) &mdash; Indonesia

This page documents BM25 regression experiments for [MIRACL (v1.0) &mdash; Indonesia](https://github.com/project-miracl/miracl).
