...
java -cp $fatjar $jvm_args io.anserini.search.SearchCollection \
    ...
    -index msmarco-v2.1-doc-segmented-full \
    -topics rag25.test \
    -output runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt \
    -hits 1000 \
    -bm25
```
...
```bash
java -cp $fatjar trec_eval -c -m ndcg_cut.30 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
java -cp $fatjar trec_eval -c -m ndcg_cut.100 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
java -cp $fatjar trec_eval -c -m recall.100 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
```
...
```bash
java -cp $fatjar trec_eval -c -m ndcg_cut.30 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
java -cp $fatjar trec_eval -c -m ndcg_cut.100 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
java -cp $fatjar trec_eval -c -m recall.100 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.bm25-full.rag25.test.txt
```
...
#### rag25.test.splade-v3 / rag25.test-umbrela2
...
java -cp $fatjar $jvm_args io.anserini.search.SearchCollection \
    -threads 16 \
    -index msmarco-v2.1-doc-segmented.splade-v3 \
    -topics rag25.test.splade-v3 \
    -output runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt \
    -impact \
    -pretokenized \
    -removeQuery \
    -hits 1000
...
```bash
java -cp $fatjar trec_eval -c -m ndcg_cut.30 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
java -cp $fatjar trec_eval -c -m ndcg_cut.100 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
java -cp $fatjar trec_eval -c -m recall.100 rag25.test-umbrela2 runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
```

#### rag25.test.splade-v3 / rag25.test
...
```bash
java -cp $fatjar trec_eval -c -m ndcg_cut.30 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
java -cp $fatjar trec_eval -c -m ndcg_cut.100 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
java -cp $fatjar trec_eval -c -m recall.100 rag25.test runs/run.msmarco-v2.1-doc-segmented.optional.splade-v3.cached.rag25.test.splade-v3.txt
```
