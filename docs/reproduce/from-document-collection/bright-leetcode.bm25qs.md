...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-leetcode runs/run.bright-leetcode.bm25qs.topics.bright-leetcode.txt
bin/trec_eval -c -m recall.100 bright-leetcode runs/run.bright-leetcode.bm25qs.topics.bright-leetcode.txt
bin/trec_eval -c -m recall.1000 bright-leetcode runs/run.bright-leetcode.bm25qs.topics.bright-leetcode.txt
```
