...
+ [`topics.nanoknow-v1.0-nq.supported.tsv`](https://github.com/castorini/eval/tree/master/topics/topics.nanoknow-v1.0-nq.supported.tsv): 2,389 NQ-Open validation questions in `qid\tquery` TSV format.
+ [`qrels.nanoknow-v1.0-nq.supported.txt`](https://github.com/castorini/eval/tree/master/qrels/qrels.nanoknow-v1.0-nq.supported.txt): NanoKnow v1.0 supported-document qrels in TREC format.
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -topicReader TsvInt \
  -output runs/run.lucene-inverted.fineweb-edu-100b-karpathy.model-bm25.topics-nanoknow-v1.0-nq.supported.txt \
  -bm25 &
```
...
```bash
bin/trec_eval -c -m recall.20 nanoknow-v1.0-nq.supported runs/run.lucene-inverted.fineweb-edu-100b-karpathy.model-bm25.topics-nanoknow-v1.0-nq.supported.txt
```
