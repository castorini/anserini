...
```bash
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-en.train runs/run.mrtydi-v1.1-en.bm25.topics.mrtydi-v1.1-en.train.txt
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-en.dev runs/run.mrtydi-v1.1-en.bm25.topics.mrtydi-v1.1-en.dev.txt
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-en.test runs/run.mrtydi-v1.1-en.bm25.topics.mrtydi-v1.1-en.test.txt
```
