...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --regression beir-v1.0.0-arguana.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
