...
```bash
bin/trec_eval -m map -c -l 2 dl19-passage runs/run.msmarco-passage-cos-dpr-distil.parquet.cos-dpr-distil-flat-onnx.topics.dl19-passage.txt
bin/trec_eval -m ndcg_cut.10 -c dl19-passage runs/run.msmarco-passage-cos-dpr-distil.parquet.cos-dpr-distil-flat-onnx.topics.dl19-passage.txt
bin/trec_eval -m recall.100 -c -l 2 dl19-passage runs/run.msmarco-passage-cos-dpr-distil.parquet.cos-dpr-distil-flat-onnx.topics.dl19-passage.txt
bin/trec_eval -m recall.1000 -c -l 2 dl19-passage runs/run.msmarco-passage-cos-dpr-distil.parquet.cos-dpr-distil-flat-onnx.topics.dl19-passage.txt
```
