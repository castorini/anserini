...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/dl20-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx.yaml).
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --regression dl20-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --download --index --verify --search --regression dl20-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
...
To add to this reproduction log, modify [this template](../../../src/main/resources/reproduce/from-document-collection/docgen/dl20-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx.template) and run `bin/build.sh` to rebuild the documentation.
