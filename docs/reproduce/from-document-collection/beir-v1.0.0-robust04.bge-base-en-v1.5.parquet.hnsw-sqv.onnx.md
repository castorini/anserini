...
bin/run.sh io.anserini.search.SearchHnswDenseVectors \
  ...
  -output runs/run.lucene-hnsw-sqv.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-beir-v1.0.0-robust04.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-robust04.test runs/run.lucene-hnsw-sqv.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-beir-v1.0.0-robust04.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-robust04.test runs/run.lucene-hnsw-sqv.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-beir-v1.0.0-robust04.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-robust04.test runs/run.lucene-hnsw-sqv.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-beir-v1.0.0-robust04.test.txt
```
