...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-stackoverflow runs/run.bright-stackoverflow.bge-large-en-v1.5.bge-flat-onnx.topics.bright-stackoverflow.txt
bin/trec_eval -c -m recall.100 bright-stackoverflow runs/run.bright-stackoverflow.bge-large-en-v1.5.bge-flat-onnx.topics.bright-stackoverflow.txt
bin/trec_eval -c -m recall.1000 bright-stackoverflow runs/run.bright-stackoverflow.bge-large-en-v1.5.bge-flat-onnx.topics.bright-stackoverflow.txt
```
