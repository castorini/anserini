...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --regression rag24-doc-segmented-test-umbrela.arctic-embed-l.parquet.shard03.flat.onnx
```
