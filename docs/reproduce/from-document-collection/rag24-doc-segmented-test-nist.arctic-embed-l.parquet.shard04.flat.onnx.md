...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config rag24-doc-segmented-test-nist.arctic-embed-l.parquet.shard04.flat.onnx
```
