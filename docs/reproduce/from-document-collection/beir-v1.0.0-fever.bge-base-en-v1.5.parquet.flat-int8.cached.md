...
<<<<<<<< HEAD:docs/reproduce/from-document-collection/regressions-beir-v1.0.0-fever.bge-base-en-v1.5.parquet.flat-sqv.cached.md
The exact configurations for these regressions are stored in [this YAML file](../../src/main/resources/regression/beir-v1.0.0-fever.bge-base-en-v1.5.parquet.flat-sqv.cached.yaml).
...
========
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/beir-v1.0.0-fever.bge-base-en-v1.5.parquet.flat-int8.cached.yaml).
...
>>>>>>>> master:docs/reproduce/from-document-collection/beir-v1.0.0-fever.bge-base-en-v1.5.parquet.flat-int8.cached.md

From one of our Waterloo servers (e.g., `orca`), the following command will perform the complete regression, end to end:

```
python src/main/python/run_regression.py --index --verify --search --regression beir-v1.0.0-fever.bge-base-en-v1.5.parquet.flat-sqv.cached
```
...
bin/run.sh io.anserini.index.IndexFlatDenseVectors \
  ...
  -index indexes/lucene-flat-sqv.beir-v1.0.0-fever.bge-base-en-v1.5/ \
  -quantize.sqv \
...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.beir-v1.0.0-fever.bge-base-en-v1.5.bge-flat-sqv-cached.topics.beir-v1.0.0-fever.test.bge-base-en-v1.5.jsonl.txt \
...
```
bin/trec_eval -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.bge-base-en-v1.5.bge-flat-sqv-cached.topics.beir-v1.0.0-fever.test.bge-base-en-v1.5.jsonl.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.bge-base-en-v1.5.bge-flat-sqv-cached.topics.beir-v1.0.0-fever.test.bge-base-en-v1.5.jsonl.txt
bin/trec_eval -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-fever.test.txt runs/run.beir-v1.0.0-fever.bge-base-en-v1.5.bge-flat-sqv-cached.topics.beir-v1.0.0-fever.test.bge-base-en-v1.5.jsonl.txt
```
