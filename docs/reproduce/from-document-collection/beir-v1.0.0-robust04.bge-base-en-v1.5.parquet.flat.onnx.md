...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/beir-v1.0.0-robust04.bge-base-en-v1.5.parquet.flat.onnx.yaml).
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config beir-v1.0.0-robust04.bge-base-en-v1.5.parquet.flat.onnx
```
...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.lucene-flat.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-flat-onnx.topics-beir-v1.0.0-robust04.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-robust04.test runs/run.lucene-flat.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-flat-onnx.topics-beir-v1.0.0-robust04.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-robust04.test runs/run.lucene-flat.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-flat-onnx.topics-beir-v1.0.0-robust04.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-robust04.test runs/run.lucene-flat.beir-v1.0.0-robust04.bge-base-en-v1.5.model-bge-flat-onnx.topics-beir-v1.0.0-robust04.test.txt
```
