...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --regression rag25-doc-segmented-test-nist.arctic-embed-l.parquet.shard04.flat.onnx
```
...
```bash
bin/trec_eval -c -m ndcg_cut.30 tools/topics-and-qrels/qrels.rag25.test.txt runs/run.msmarco-v2.1-doc-segmented-shard00.arctic-embed-l.arctic-embed-l-flat-onnx.topics.rag25.test.jsonl.txt
bin/trec_eval -c -m ndcg_cut.100 tools/topics-and-qrels/qrels.rag25.test.txt runs/run.msmarco-v2.1-doc-segmented-shard00.arctic-embed-l.arctic-embed-l-flat-onnx.topics.rag25.test.jsonl.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.rag25.test.txt runs/run.msmarco-v2.1-doc-segmented-shard00.arctic-embed-l.arctic-embed-l-flat-onnx.topics.rag25.test.jsonl.txt
```
