...
<<<<<<<< HEAD:docs/reproduce/from-document-collection/regressions-beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.parquet.flat-sqv.onnx.md
The exact configurations for these regressions are stored in [this YAML file](../../src/main/resources/regression/beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.parquet.flat-sqv.onnx.yaml).
...
========
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.parquet.flat-int8.onnx.yaml).
...
>>>>>>>> master:docs/reproduce/from-document-collection/beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.parquet.flat-int8.onnx.md

From one of our Waterloo servers (e.g., `orca`), the following command will perform the complete regression, end to end:

```
python src/main/python/run_regression.py --index --verify --search --regression beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-webis-touche2020.test.txt \
...
```
bin/trec_eval -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-webis-touche2020.test.txt runs/run.beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-webis-touche2020.test.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-webis-touche2020.test.txt runs/run.beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-webis-touche2020.test.txt
bin/trec_eval -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-webis-touche2020.test.txt runs/run.beir-v1.0.0-webis-touche2020.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-webis-touche2020.test.txt
```
...
|:-------------------------------------------------------------------------------------------------------------|---------------------|
| BEIR (v1.0.0): Webis-Touche2020                                                                              | 0.2571              |
| **R@100**                                                                                                    | **BGE-base-en-v1.5**|
| BEIR (v1.0.0): Webis-Touche2020                                                                              | 0.4867              |
