...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -output runs/run.lucene-inverted.beir-v1.0.0-climate-fever.splade-pp-ed.model-splade-pp-ed-onnx.topics-beir-v1.0.0-climate-fever.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-climate-fever.test runs/run.lucene-inverted.beir-v1.0.0-climate-fever.splade-pp-ed.model-splade-pp-ed-onnx.topics-beir-v1.0.0-climate-fever.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-climate-fever.test runs/run.lucene-inverted.beir-v1.0.0-climate-fever.splade-pp-ed.model-splade-pp-ed-onnx.topics-beir-v1.0.0-climate-fever.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-climate-fever.test runs/run.lucene-inverted.beir-v1.0.0-climate-fever.splade-pp-ed.model-splade-pp-ed-onnx.topics-beir-v1.0.0-climate-fever.test.txt
```
