...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config dl19-passage.bge-base-en-v1.5.parquet.hnsw-sqv.onnx
```
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --download --index --verify --search --config dl19-passage.bge-base-en-v1.5.parquet.hnsw-sqv.onnx
```
