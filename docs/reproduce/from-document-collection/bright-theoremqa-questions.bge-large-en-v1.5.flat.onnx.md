...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-theoremqa-questions runs/run.bright-theoremqa-questions.bge-large-en-v1.5.bge-flat-onnx.topics.bright-theoremqa-questions.txt
bin/trec_eval -c -m recall.100 bright-theoremqa-questions runs/run.bright-theoremqa-questions.bge-large-en-v1.5.bge-flat-onnx.topics.bright-theoremqa-questions.txt
bin/trec_eval -c -m recall.1000 bright-theoremqa-questions runs/run.bright-theoremqa-questions.bge-large-en-v1.5.bge-flat-onnx.topics.bright-theoremqa-questions.txt
```
