...
```bash
bin/trec_eval -c -m recall.100 msmarco-v2-passage.dev runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev.txt
bin/trec_eval -c -m recall.1000 msmarco-v2-passage.dev runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev.txt
bin/trec_eval -c -M 100 -m map -c -M 100 -m recip_rank msmarco-v2-passage.dev runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev.txt
bin/trec_eval -c -m recall.100 msmarco-v2-passage.dev2 runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev2.txt
bin/trec_eval -c -m recall.1000 msmarco-v2-passage.dev2 runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev2.txt
bin/trec_eval -c -M 100 -m map -c -M 100 -m recip_rank msmarco-v2-passage.dev2 runs/run.msmarco-v2-passage.bm25-default.topics.msmarco-v2-passage.dev2.txt
```
