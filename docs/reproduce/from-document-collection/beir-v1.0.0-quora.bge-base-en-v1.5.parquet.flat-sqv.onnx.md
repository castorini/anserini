...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-quora.test runs/run.beir-v1.0.0-quora.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-quora.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-quora.test runs/run.beir-v1.0.0-quora.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-quora.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-quora.test runs/run.beir-v1.0.0-quora.bge-base-en-v1.5.bge-flat-sqv-onnx.topics.beir-v1.0.0-quora.test.txt
```
