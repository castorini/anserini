...
<<<<<<<< HEAD:docs/reproduce/from-document-collection/regressions-dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx.md
The exact configurations for these regressions are stored in [this YAML file](../../src/main/resources/regression/dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx.yaml).
...
========
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/dl20-passage.cos-dpr-distil.parquet.flat-int8.onnx.yaml).
...
>>>>>>>> master:docs/reproduce/from-document-collection/dl20-passage.cos-dpr-distil.parquet.flat-int8.onnx.md

From one of our Waterloo servers (e.g., `orca`), the following command will perform the complete regression, end to end:

```bash
python src/main/python/run_regression.py --index --verify --search --regression dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx
```
...
```bash
python src/main/python/run_regression.py --download --index --verify --search --regression dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx
```
...
<<<<<<<< HEAD:docs/reproduce/from-document-collection/regressions-dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx.md
To add to this reproduction log, modify [this template](../../src/main/resources/docgen/templates/dl20-passage.cos-dpr-distil.parquet.flat-sqv.onnx.template) and run `bin/build.sh` to rebuild the documentation.
========
To add to this reproduction log, modify [this template](../../../src/main/resources/reproduce/from-document-collection/docgen/dl20-passage.cos-dpr-distil.parquet.flat-int8.onnx.template) and run `bin/build.sh` to rebuild the documentation.
>>>>>>>> master:docs/reproduce/from-document-collection/dl20-passage.cos-dpr-distil.parquet.flat-int8.onnx.md
