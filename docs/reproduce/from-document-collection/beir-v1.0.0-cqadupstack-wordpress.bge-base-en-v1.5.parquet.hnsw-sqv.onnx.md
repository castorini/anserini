...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config beir-v1.0.0-cqadupstack-wordpress.bge-base-en-v1.5.parquet.hnsw-sqv.onnx
```
