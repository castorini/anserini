...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config dl21-doc-segmented-msmarco-v2.1.splade-v3.cached
```
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --download --index --verify --search --config dl21-doc-segmented-msmarco-v2.1.splade-v3.cached
```
