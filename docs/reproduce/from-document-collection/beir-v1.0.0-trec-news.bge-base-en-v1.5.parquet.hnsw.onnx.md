...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-trec-news.test runs/run.beir-v1.0.0-trec-news.bge-base-en-v1.5.bge-hnsw-onnx.topics.beir-v1.0.0-trec-news.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-trec-news.test runs/run.beir-v1.0.0-trec-news.bge-base-en-v1.5.bge-hnsw-onnx.topics.beir-v1.0.0-trec-news.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-trec-news.test runs/run.beir-v1.0.0-trec-news.bge-base-en-v1.5.bge-hnsw-onnx.topics.beir-v1.0.0-trec-news.test.txt
```
