...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard09.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag24.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.20 rag24.test-umbrela-all runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard09.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag24.test.txt
bin/trec_eval -c -m ndcg_cut.100 rag24.test-umbrela-all runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard09.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag24.test.txt
bin/trec_eval -c -m recall.100 rag24.test-umbrela-all runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard09.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag24.test.txt
```
