...
<<<<<<<< HEAD:docs/reproduce/from-document-collection/regressions-msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx.md
The exact configurations for these regressions are stored in [this YAML file](../../src/main/resources/regression/msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx.yaml).
...
========
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-int8.onnx.yaml).
...
>>>>>>>> master:docs/reproduce/from-document-collection/msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-int8.onnx.md

From one of our Waterloo servers (e.g., `orca`), the following command will perform the complete regression, end to end:

```bash
python src/main/python/run_regression.py --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
...
```bash
python src/main/python/run_regression.py --download --index --verify --search --regression msmarco-v1-passage.bge-base-en-v1.5.parquet.flat-sqv.onnx
```
