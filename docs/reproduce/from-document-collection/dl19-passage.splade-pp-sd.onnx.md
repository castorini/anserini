...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/dl19-passage.splade-pp-sd.onnx.yaml).
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config dl19-passage.splade-pp-sd.onnx
```
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --download --index --verify --search --config dl19-passage.splade-pp-sd.onnx
```
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -topics dl19-passage \
  -topicReader TsvInt \
  -output runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx.topics-dl19-passage.txt \
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -topics dl19-passage \
  -topicReader TsvInt \
  -output runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rm3.topics-dl19-passage.txt \
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -topics dl19-passage \
  -topicReader TsvInt \
  -output runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rocchio.topics-dl19-passage.txt \
...
```bash
bin/trec_eval -m map -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx.topics-dl19-passage.txt
bin/trec_eval -m ndcg_cut.10 -c dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx.topics-dl19-passage.txt
bin/trec_eval -m recall.100 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx.topics-dl19-passage.txt
bin/trec_eval -m recall.1000 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx.topics-dl19-passage.txt

bin/trec_eval -m map -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rm3.topics-dl19-passage.txt
bin/trec_eval -m ndcg_cut.10 -c dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rm3.topics-dl19-passage.txt
bin/trec_eval -m recall.100 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rm3.topics-dl19-passage.txt
bin/trec_eval -m recall.1000 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rm3.topics-dl19-passage.txt

bin/trec_eval -m map -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rocchio.topics-dl19-passage.txt
bin/trec_eval -m ndcg_cut.10 -c dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rocchio.topics-dl19-passage.txt
bin/trec_eval -m recall.100 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rocchio.topics-dl19-passage.txt
bin/trec_eval -m recall.1000 -c -l 2 dl19-passage runs/run.lucene-inverted.msmarco-v1-passage.splade-pp-sd.model-splade-pp-sd-onnx+rocchio.topics-dl19-passage.txt
```
...
To add to this reproduction log, modify [this template](../../../src/main/resources/reproduce/from-document-collection/docgen/dl19-passage.splade-pp-sd.onnx.template) and run `bin/build.sh` to rebuild the documentation.
