...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/beir-v1.0.0-trec-news.splade-v3.onnx.yaml).
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config beir-v1.0.0-trec-news.splade-v3.onnx
```
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -output runs/run.lucene-inverted.beir-v1.0.0-trec-news.splade-v3.model-splade-v3-onnx.topics-beir-v1.0.0-trec-news.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-trec-news.test runs/run.lucene-inverted.beir-v1.0.0-trec-news.splade-v3.model-splade-v3-onnx.topics-beir-v1.0.0-trec-news.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-trec-news.test runs/run.lucene-inverted.beir-v1.0.0-trec-news.splade-v3.model-splade-v3-onnx.topics-beir-v1.0.0-trec-news.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-trec-news.test runs/run.lucene-inverted.beir-v1.0.0-trec-news.splade-v3.model-splade-v3-onnx.topics-beir-v1.0.0-trec-news.test.txt
```
