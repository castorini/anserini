...
```bash
bin/trec_eval -c -M 100 -m map dl23-doc-msmarco-v2.1 runs/run.msmarco-v2.1-doc-segmented-splade-v3.splade-v3-onnx.topics.dl23.txt
bin/trec_eval -c -m recall.100 dl23-doc-msmarco-v2.1 runs/run.msmarco-v2.1-doc-segmented-splade-v3.splade-v3-onnx.topics.dl23.txt
bin/trec_eval -c -m recall.1000 dl23-doc-msmarco-v2.1 runs/run.msmarco-v2.1-doc-segmented-splade-v3.splade-v3-onnx.topics.dl23.txt
bin/trec_eval -c -M 100 -m recip_rank -c -m ndcg_cut.10 dl23-doc-msmarco-v2.1 runs/run.msmarco-v2.1-doc-segmented-splade-v3.splade-v3-onnx.topics.dl23.txt
```
