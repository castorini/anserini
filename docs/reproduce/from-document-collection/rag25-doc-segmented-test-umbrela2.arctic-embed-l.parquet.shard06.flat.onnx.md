...
This page documents experiments for `shard06`; we expect the corpus to be in `msmarco_v2.1_doc_segmented.arctic-embed-l/shard06` (relative to the base collection path).
...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/rag25-doc-segmented-test-umbrela2.arctic-embed-l.parquet.shard06.flat.onnx.yaml).
Note that this page is automatically generated from [this template](../../../src/main/resources/reproduce/from-document-collection/docgen/rag25-doc-segmented-test-umbrela2.arctic-embed-l.parquet.shard06.flat.onnx.template) as part of Anserini's regression pipeline, so do not modify this page directly; modify the template instead.

From one of our Waterloo servers (e.g., `orca`), the following command will perform the complete regression, end to end:

```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config rag25-doc-segmented-test-umbrela2.arctic-embed-l.parquet.shard06.flat.onnx
```
...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard06.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag25.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.30 rag25.test-umbrela2 runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard06.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag25.test.txt
bin/trec_eval -c -m ndcg_cut.100 rag25.test-umbrela2 runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard06.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag25.test.txt
bin/trec_eval -c -m recall.100 rag25.test-umbrela2 runs/run.lucene-flat.msmarco-v2.1-doc-segmented-shard06.arctic-embed-l.model-arctic-embed-l-flat-onnx.topics-rag25.test.txt
```
...
|:---------------------|:----------------:|
| RAG 25: Test queries | 0.1710           |
| **nDCG@100**         | **ArcticEmbedL** |
| RAG 25: Test queries | 0.1192           |
| **R@100**            | **ArcticEmbedL** |
| RAG 25: Test queries | 0.0379           |
