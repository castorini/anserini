...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-fiqa.test runs/run.beir-v1.0.0-fiqa.splade-v3.splade-v3-onnx.topics.beir-v1.0.0-fiqa.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-fiqa.test runs/run.beir-v1.0.0-fiqa.splade-v3.splade-v3-onnx.topics.beir-v1.0.0-fiqa.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-fiqa.test runs/run.beir-v1.0.0-fiqa.splade-v3.splade-v3-onnx.topics.beir-v1.0.0-fiqa.test.txt
```
