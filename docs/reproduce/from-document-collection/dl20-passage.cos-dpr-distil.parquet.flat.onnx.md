...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config dl20-passage.cos-dpr-distil.parquet.flat.onnx
```
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --download --index --verify --search --config dl20-passage.cos-dpr-distil.parquet.flat.onnx
```
...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -topics dl20 \
  -topicReader TsvInt \
  -output runs/run.lucene-flat.msmarco-v1-passage.cos-dpr-distil.model-cos-dpr-distil-flat-onnx.topics-dl20.txt \
...
```bash
bin/trec_eval -m map -c -l 2 dl20-passage runs/run.lucene-flat.msmarco-v1-passage.cos-dpr-distil.model-cos-dpr-distil-flat-onnx.topics-dl20.txt
bin/trec_eval -m ndcg_cut.10 -c dl20-passage runs/run.lucene-flat.msmarco-v1-passage.cos-dpr-distil.model-cos-dpr-distil-flat-onnx.topics-dl20.txt
bin/trec_eval -m recall.100 -c -l 2 dl20-passage runs/run.lucene-flat.msmarco-v1-passage.cos-dpr-distil.model-cos-dpr-distil-flat-onnx.topics-dl20.txt
bin/trec_eval -m recall.1000 -c -l 2 dl20-passage runs/run.lucene-flat.msmarco-v1-passage.cos-dpr-distil.model-cos-dpr-distil-flat-onnx.topics-dl20.txt
```
