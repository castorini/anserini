...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -output runs/run.lucene-flat-sqv.beir-v1.0.0-cqadupstack-unix.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-beir-v1.0.0-cqadupstack-unix.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-cqadupstack-unix.test runs/run.lucene-flat-sqv.beir-v1.0.0-cqadupstack-unix.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-beir-v1.0.0-cqadupstack-unix.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-cqadupstack-unix.test runs/run.lucene-flat-sqv.beir-v1.0.0-cqadupstack-unix.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-beir-v1.0.0-cqadupstack-unix.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-cqadupstack-unix.test runs/run.lucene-flat-sqv.beir-v1.0.0-cqadupstack-unix.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-beir-v1.0.0-cqadupstack-unix.test.txt
```
