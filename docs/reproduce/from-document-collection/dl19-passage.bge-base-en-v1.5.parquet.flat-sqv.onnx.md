...
bin/run.sh io.anserini.search.SearchFlatDenseVectors \
  ...
  -topics dl19-passage \
  -topicReader TsvInt \
  -output runs/run.lucene-flat-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-dl19-passage.txt \
...
```bash
bin/trec_eval -m map -c -l 2 dl19-passage runs/run.lucene-flat-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-dl19-passage.txt
bin/trec_eval -m ndcg_cut.10 -c dl19-passage runs/run.lucene-flat-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-dl19-passage.txt
bin/trec_eval -m recall.100 -c -l 2 dl19-passage runs/run.lucene-flat-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-dl19-passage.txt
bin/trec_eval -m recall.1000 -c -l 2 dl19-passage runs/run.lucene-flat-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-flat-sqv-onnx.topics-dl19-passage.txt
```
