...
```bash
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-ja.train runs/run.mrtydi-v1.1-ja.bm25.topics.mrtydi-v1.1-ja.train.txt
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-ja.dev runs/run.mrtydi-v1.1-ja.bm25.topics.mrtydi-v1.1-ja.dev.txt
bin/trec_eval -c -M 100 -m recip_rank -c -m recall.100 mrtydi-v1.1-ja.test runs/run.mrtydi-v1.1-ja.bm25.topics.mrtydi-v1.1-ja.test.txt
```
