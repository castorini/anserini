...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-earth-science runs/run.bright-earth-science.bm25qs.topics.bright-earth-science.txt
bin/trec_eval -c -m recall.100 bright-earth-science runs/run.bright-earth-science.bm25qs.topics.bright-earth-science.txt
bin/trec_eval -c -m recall.1000 bright-earth-science runs/run.bright-earth-science.bm25qs.topics.bright-earth-science.txt
```
