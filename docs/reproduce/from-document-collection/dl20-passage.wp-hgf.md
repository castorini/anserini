...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --config dl20-passage.wp-hgf
```
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -topics dl20 \
  -topicReader TsvInt \
  -output runs/run.lucene-inverted.msmarco-v1-passage.wp-hgf.model-bm25-default.topics-dl20.txt \
...
```bash
bin/trec_eval -m map -c -l 2 dl20-passage runs/run.lucene-inverted.msmarco-v1-passage.wp-hgf.model-bm25-default.topics-dl20.txt
bin/trec_eval -m ndcg_cut.10 -c dl20-passage runs/run.lucene-inverted.msmarco-v1-passage.wp-hgf.model-bm25-default.topics-dl20.txt
bin/trec_eval -m recall.100 -c -l 2 dl20-passage runs/run.lucene-inverted.msmarco-v1-passage.wp-hgf.model-bm25-default.topics-dl20.txt
bin/trec_eval -m recall.1000 -c -l 2 dl20-passage runs/run.lucene-inverted.msmarco-v1-passage.wp-hgf.model-bm25-default.topics-dl20.txt
```
