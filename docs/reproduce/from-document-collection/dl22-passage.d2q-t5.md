...
```bash
bin/trec_eval -c -M 100 -m map -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default.topics.dl22.txt
bin/trec_eval -c -M 100 -m recip_rank -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default.topics.dl22.txt
bin/trec_eval -c -m ndcg_cut.10 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default.topics.dl22.txt
bin/trec_eval -c -m recall.100 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default.topics.dl22.txt
bin/trec_eval -c -m recall.1000 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default.topics.dl22.txt

bin/trec_eval -c -M 100 -m map -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rm3.topics.dl22.txt
bin/trec_eval -c -M 100 -m recip_rank -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rm3.topics.dl22.txt
bin/trec_eval -c -m ndcg_cut.10 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rm3.topics.dl22.txt
bin/trec_eval -c -m recall.100 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rm3.topics.dl22.txt
bin/trec_eval -c -m recall.1000 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rm3.topics.dl22.txt

bin/trec_eval -c -M 100 -m map -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rocchio.topics.dl22.txt
bin/trec_eval -c -M 100 -m recip_rank -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rocchio.topics.dl22.txt
bin/trec_eval -c -m ndcg_cut.10 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rocchio.topics.dl22.txt
bin/trec_eval -c -m recall.100 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rocchio.topics.dl22.txt
bin/trec_eval -c -m recall.1000 -l 2 dl22-passage runs/run.msmarco-v2-passage-d2q-t5.bm25-default+rocchio.topics.dl22.txt
```
