...
The exact configurations for these regressions are stored in [this YAML file](../../src/main/resources/reproduce/from-document-collection/configs/msmarco-v1-passage.splade-pp-ed.cached.yaml).
...
To add to this reproduction log, modify [this template](../../src/main/resources/reproduce/from-document-collection/docgen/msmarco-v1-passage.splade-pp-ed.cached.template) and run `bin/build.sh` to rebuild the documentation.
