...
The exact configurations for these regressions are stored in [this YAML file](../../../src/main/resources/reproduce/from-document-collection/configs/beir-v1.0.0-cqadupstack-physics.splade-pp-ed.onnx.yaml).
...
```bash
bin/run.sh io.anserini.reproduce.ReproduceFromDocumentCollection --index --verify --search --regression beir-v1.0.0-cqadupstack-physics.splade-pp-ed.onnx
```
...
bin/run.sh io.anserini.search.SearchCollection \
  ...
  -output runs/run.beir-v1.0.0-cqadupstack-physics.splade-pp-ed.splade-pp-ed-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.splade-pp-ed.splade-pp-ed-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
bin/trec_eval -c -m recall.100 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.splade-pp-ed.splade-pp-ed-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
bin/trec_eval -c -m recall.1000 tools/topics-and-qrels/qrels.beir-v1.0.0-cqadupstack-physics.test.txt runs/run.beir-v1.0.0-cqadupstack-physics.splade-pp-ed.splade-pp-ed-onnx.topics.beir-v1.0.0-cqadupstack-physics.test.txt
```
