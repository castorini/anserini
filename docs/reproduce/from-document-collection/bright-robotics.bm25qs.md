...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-robotics runs/run.bright-robotics.bm25qs.topics.bright-robotics.txt
bin/trec_eval -c -m recall.100 bright-robotics runs/run.bright-robotics.bm25qs.topics.bright-robotics.txt
bin/trec_eval -c -m recall.1000 bright-robotics runs/run.bright-robotics.bm25qs.topics.bright-robotics.txt
```
