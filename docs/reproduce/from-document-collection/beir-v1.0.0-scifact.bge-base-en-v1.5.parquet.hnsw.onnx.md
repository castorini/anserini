...
bin/run.sh io.anserini.search.SearchHnswDenseVectors \
  ...
  -output runs/run.lucene-hnsw.beir-v1.0.0-scifact.bge-base-en-v1.5.model-bge-hnsw-onnx.topics-beir-v1.0.0-scifact.test.txt \
...
```bash
bin/trec_eval -c -m ndcg_cut.10 beir-v1.0.0-scifact.test runs/run.lucene-hnsw.beir-v1.0.0-scifact.bge-base-en-v1.5.model-bge-hnsw-onnx.topics-beir-v1.0.0-scifact.test.txt
bin/trec_eval -c -m recall.100 beir-v1.0.0-scifact.test runs/run.lucene-hnsw.beir-v1.0.0-scifact.bge-base-en-v1.5.model-bge-hnsw-onnx.topics-beir-v1.0.0-scifact.test.txt
bin/trec_eval -c -m recall.1000 beir-v1.0.0-scifact.test runs/run.lucene-hnsw.beir-v1.0.0-scifact.bge-base-en-v1.5.model-bge-hnsw-onnx.topics-beir-v1.0.0-scifact.test.txt
```
