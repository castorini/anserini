...
```bash
bin/trec_eval -c -m ndcg_cut.10 bright-biology runs/run.bright-biology.bm25qs.topics.bright-biology.txt
bin/trec_eval -c -m recall.100 bright-biology runs/run.bright-biology.bm25qs.topics.bright-biology.txt
bin/trec_eval -c -m recall.1000 bright-biology runs/run.bright-biology.bm25qs.topics.bright-biology.txt
```
