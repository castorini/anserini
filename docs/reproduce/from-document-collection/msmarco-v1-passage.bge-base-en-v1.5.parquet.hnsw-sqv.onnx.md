...
bin/run.sh io.anserini.search.SearchHnswDenseVectors \
  ...
  -topicReader TsvInt \
  -output runs/run.lucene-hnsw-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-msmarco-passage.dev-subset.txt \
...
```bash
bin/trec_eval -c -m map msmarco-passage.dev-subset runs/run.lucene-hnsw-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-msmarco-passage.dev-subset.txt
bin/trec_eval -c -M 10 -m recip_rank msmarco-passage.dev-subset runs/run.lucene-hnsw-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-msmarco-passage.dev-subset.txt
bin/trec_eval -c -m recall.100 msmarco-passage.dev-subset runs/run.lucene-hnsw-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-msmarco-passage.dev-subset.txt
bin/trec_eval -c -m recall.1000 msmarco-passage.dev-subset runs/run.lucene-hnsw-sqv.msmarco-v1-passage.bge-base-en-v1.5.model-bge-hnsw-sqv-onnx.topics-msmarco-passage.dev-subset.txt
```
